...
test('Field 9(5) is not valid', { timeout }, async ({ equal }) => {
    const f = new Field({ picStr: '9(5)', type: Type._9 });
...
test('Field 9(5)', { timeout }, async ({ equal }) => {
    const f = new Field({ picStr: '9(5)', type: Type._9, value: 12345 });
...
test('Field 9(5) (PicType)', { timeout }, async ({ equal }) => {
    const f = new Field({ picType: new PicType('9', 5), type: Type.Unsigned, value: 12345 });
...
test('Field 9(5) (Overflow)', { timeout }, async ({ equal }) => {
    const f = new Field({ picStr: '9(5)', type: Type._9, value: 123456 });

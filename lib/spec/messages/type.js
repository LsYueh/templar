...
/**
 * @class Subsystem
 * @property {string} name 9(2) SUBSYSTEM-NAME
 * @property {string} description 說明
 * @property {{id: string, define: MessageDef_t}[]} messages 該Subsystem下所擁有的訊息格式
 */
class Subsystem {
    /**
     * @param {object} options 
 ...
 * @class Message_t
 * @property {string} id MESSAGE-ID
 * @property {object} header Message Header
 * @property {object[]} body Message Body
 * @property {string} remained 剩餘電文
 * @property {string} raw 原始電文  
 */
class Message_t {
    /** @type {string} MESSAGE-ID */
    id;

...
/** Body specs */
const SPEC = {
    R1: common.specFactory(R1, 'R1'),
    R2: common.specFactory(R2, 'R2'),
    R3: common.specFactory(R3, 'R3'),
    R4: common.specFactory(R4, 'R4'),
    R5: common.specFactory(R5, 'R5'),
    R6: common.specFactory(R6, 'R6'),
};

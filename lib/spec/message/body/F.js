...
const SPEC = {
    // 傳送功能
    F010: common.specFactory(F010, 'F010'),
    F030: common.specFactory(F030, 'F030'), F040: common.specFactory(F040, 'F040'),
    F050: common.specFactory(F050, 'F050'), F060: common.specFactory(F060, 'F060'),
    F210: common.specFactory(F210, 'F210'), F220: common.specFactory(F220, 'F220'),
    
    // 接收功能
    F090: common.specFactory(F090, 'F090'),
    F110: common.specFactory(F110, 'F110'), F120: common.specFactory(F120, 'F120'),
    F130: common.specFactory(F130, 'F130'), F140: common.specFactory(F140, 'F140'),
    F230: common.specFactory(F230, 'F230'), F240: common.specFactory(F240, 'F240'),
};

...
class PicType {
     ...
     */
    get decimals() {
        return (this.#decimals > 0) ? this.#decimals : 0;
    }
...
/**
 * Native Addon: parseUnit
 * 
 * @typedef {Object} Token
 * @property {string} char 單一 PIC 字元，轉成大寫
 * @property {number} count 數字，若省略則為 1
 */
...
function parseUnit(unit) {
    // const native = require('./cobol-pic.node');
    // return native.parseUnit(unit);
